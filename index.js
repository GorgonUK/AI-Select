      ...
      async function updateModalTitle(result) {
        ...
        const response = await fetch('https://api.openai.com/v1/chat/completions', {
          ...
          body: JSON.stringify({
            ...
            messages: [{
              role: 'system',
              content: 'You must only respond in the following language: ' + result.selectedLanguage + ', summarise/categorise the user input in less than 25 characters and only respond with the it.\n\nRole: AI assistant\n\nYour purpose is to assist users by providing helpful and informative responses in the selected language.'
            }, {
              role: 'user',
              content: prompt
            }]
